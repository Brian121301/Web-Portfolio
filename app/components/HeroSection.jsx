      ...
      <section>
        <div className=" grid grid-cols-1 lg:grid-cols-12">
          ...
          >
            ...
            <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-[#a2d6e5] to-[#bdb8b8] mb-4 text-6xl lg:text-8xl font-extrabold">
              Brian Najera
            </h1>
            <TypeAnimation
              sequence={[
            ...
            <div>
              ...
              >
                <button className="px-6 py-4 rounded-full w-full sm:w-fit mt-4 bg-[#FF6F61] hover:bg-slate-200 text-black">
                  View Resume
                </button>
              </a>
            </div>
